...
static unsigned char *set_header(char *file)
{
  ...
  pElf_Header = (Elf64_Ehdr *)data;
  pElf64_Shdr = (Elf64_Shdr *)((char *)data + pElf_Header->e_shoff);
  pElf64_Phdr = (Elf64_Phdr *)((char *)data + pElf_Header->e_phoff);
  close(fd);
